Feature: SyncMap function
  ...
  Scenario: Apply function to each element in the slice
    Given a string slice
      ...
      | b |
      | c |
    When I call SyncMap on the string slice with a function that converts each element to uppercase
  ...
  Scenario: Apply function that appends a suffix to each element
    Given a string slice
      ...
      | two |
      | three |
    When I call SyncMap on the string slice with a function that appends "-suffix" to each element
    Then the result should be string slice
      | one-suffix |
      | two-suffix |
      | three-suffix |
  ...
  Scenario: Apply function that returns the length of each element
    Given a string slice
      ...
      | two |
      | three |
    When I call SyncMap on the string slice with a function that returns the length of each element
